...
<div class="relative z-10">
    ...
    <div class="space-y-4 relative z-10">
        ...
        ?>
        <div class="flex gap-4 p-5 bg-white dark:bg-[#151517] border border-slate-200 dark:border-white/10 rounded-none hover:border-slate-955 dark:hover:border-white transition duration-300 group relative <?php echo $borderClass; ?>">
            ...
            <div class="flex-1">
                <div class="flex justify-between items-start flex-wrap gap-2">
                    ...
                    <div class="flex items-center gap-3">
                        <span class="text-[9px] font-mono text-slate-405"><?php echo Helper::timeAgo($notification['created_at']); ?></span>
                ...
                <p class="text-xs text-slate-650 dark:text-slate-350 mt-1 uppercase tracking-wide leading-relaxed"><?php echo $notification['message']; ?></p>
