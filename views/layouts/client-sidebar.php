...
<aside class="w-56 bg-neutral-light border-r border-slate-200 hidden md:flex flex-col flex-shrink-0 z-20">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <div id="nav-group-system" class="space-y-4 hidden px-3 py-2">
            <div>
                <p class="text-[9px] font-bold font-display text-slate-400 uppercase tracking-widest mb-1.5">Client Portal Status</p>
                <div class="p-3 bg-white border border-slate-200 rounded-sm">
                    ...
                    <p class="text-[8px] text-slate-400 leading-normal">Your client portal is fully connected to our booking engines.</p>
                </div>
            </div>
            <div>
                <p class="text-[9px] font-bold font-display text-slate-400 uppercase tracking-widest mb-1.5">Client Info</p>
                <div class="p-3 bg-white border border-slate-200 rounded-sm text-[8px] text-slate-400 space-y-1">
                    <p>Role: <strong class="text-slate-800">CLIENT</strong></p>
